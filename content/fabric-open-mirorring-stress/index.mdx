...
4. Your data is available in Fabric SQL endpoint in near-real time (**~30-60 seconds** in my runs until I made deliberately the system unstable)
...
I went up to **1.2 Billion Rows/Minute** on an F2 SKU, with 5 identical 32 core Windows Devboxes blasting Parquet simultaneously. The CPU was 100% hot on all machines.
...
![Open Mirrorring Experiment Observations](images/open-mirroring-experiment-observations.png)
...
F. Post Run Notable Observations - **RED** implies I broke something with my input (AKA Significant Lag and Backlog) and had to let the system heal before moving onto the next run
...
⚠️ These are **empirical** results from hacking around tunables I can think of. I'm sure there's significant improvements that can be made on the writer to squeeze out more perf from the system, once a Best Practice doc for maximum throughput is released.

</Callout>

![Open Mirrorring Experiment Results - Right Click > Open image in new tab](images/open-mirroring-experiment-results.png)
