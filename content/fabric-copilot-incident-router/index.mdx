---
title: Livesite incident triaging app with Fabric & GitHub Copilot CLI
date: 2026-02-28
published: true
...
The system below was mostly vibe coded in Python (due to the rich set of NLP libraries) with a couple manual tweaks here and there. 
...
For a simple but effective Lakehouse ODBC parallel query client, see [fabric-lakehouse-odbc.py](https://gist.github.com/mdrakiburrahman/ae17342a35f5e2cd615600f89be25708).
