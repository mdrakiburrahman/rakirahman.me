...
description: Demonstrating Spark support for Azure Schema Registry with native Event Hub endpoint and Kafka Surface
toc: true
...
💡 In this article - we set up an end-to-end event _Producer_ and _Consumer_ pipeline to demonstrate Apache Spark support for **[Azure Schema Registry](https://docs.microsoft.com/en-us/azure/event-hubs/create-schema-registry)**.
