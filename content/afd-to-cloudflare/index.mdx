...
## Interactive Parquet visualization placeholder

This is a placeholder for a future Cloudflare analytics story. For now, it is a
live demonstration of a browser reading a pre-aggregated Parquet cube directly
from Azure Blob Storage with HTTP range requests - no dashboard API or query
...
### Row groups and grouping sets

<div>
  <GroupingSetDiagram />
</div>

The source records are from the
[NYC 311 Service Requests dataset](https://opendata.cityofnewyork.us/311-service-requests-from-2010-to-present-updates/).
The Parquet cube layout and dashboard concept are credited to
[Hamilton Ulmer](https://www.hamiltonulmer.com/customer-dashboards-r2-hyparquet/).
